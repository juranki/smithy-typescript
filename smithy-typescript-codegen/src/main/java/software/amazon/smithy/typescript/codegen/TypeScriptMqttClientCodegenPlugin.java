 ...
 */
@SmithyInternalApi
public class TypeScriptMqttClientCodegenPlugin implements SmithyBuildPlugin {
    private static final Logger LOGGER = Logger.getLogger(TypeScriptMqttClientCodegenPlugin.class.getName());

    @Override
    public String getName() {
        return "typescript-mqtt-client-codegen";
    }
    ...
    public void execute(PluginContext context) {
        ...
        runner.directedCodegen(new DirectedTypeScriptMqttCodegen());
